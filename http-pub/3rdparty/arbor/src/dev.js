...
one.include('etc.js');
one.include('kernel.js');
one.include('graphics/colors.js');
one.include('graphics/primitives.js');
one.include('graphics/graphics.js');
one.include('tween/easing.js');
one.include('tween/tween.js');
one.include('physics/atoms.js');
one.include('physics/physics.js');
one.include('physics/system.js');
